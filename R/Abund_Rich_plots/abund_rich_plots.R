...
##cattle
points(ests$abund_est[ests$trt=="cattle"] ~ ests$mo_jit[ests$trt=="cattle"],pch=22,col="gray0",bg="gray0",cex=2)
...
##
legend("topright",legend=c("A"), bty="n", cex=2)
##
...
##cattle
points(ests$rich_est[ests$trt=="cattle"] ~ ests$mo_jit[ests$trt=="cattle"],pch=22,col="gray0",bg="gray0",cex=2)
...
legend("topright",legend=c("B"), bty="n", cex=2)
##
...
plot(1, type="n", xlim=c(110,345), ylim=c(0.05,3200),las=1,ylab="",xlab="",log="y")
box(lwd=2)
...
##cattle
points(ests$abund_est[ests$trt=="cattle"] ~ ests$doy[ests$trt=="cattle"],pch=22,col="gray0",bg="gray0",cex=2)
...
##
legend("bottomleft",legend=c("Bison","Cattle"), bty="n", pt.cex=2,cex=1.3, pch=c(21,22), pt.bg=c("sienna","gray0"),col=c("sienna","gray0"))
##
legend("topright",legend=c("C"), bty="n", cex=2)
##
...
##cattle
points(ests$rich_est[ests$trt=="cattle"] ~ ests$doy[ests$trt=="cattle"],pch=22,col="gray0",bg="gray0",cex=2)
...
legend("topright",legend=c("D"), bty="n", cex=2)
##
